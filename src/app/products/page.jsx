        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {categories.map(category => (
            <button
              ...
              className={`px-6 py-2 rounded-full ${activeCategory === category ? 'bg-[#039994] text-white' : 'bg-white text-gray-800'} shadow-md hover:shadow-lg transition`}
            >
              {category}
            </button>
          ))}
        ...
        {cart.length > 0 && (
          <div className="flex justify-center mb-8">
            <button 
              ...
              className="bg-[#039994] text-white px-6 py-3 rounded-lg hover:bg-[#02736f] transition flex items-center"
            >
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button 
                    ...
                    className="bg-[#039994] text-white px-4 py-2 rounded-lg hover:bg-[#02736f] transition"
                  >
                    Add to Cart
                  </button>
                </div>
